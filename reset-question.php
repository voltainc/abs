<?php 
		...
		$main = new main;
		$main->check_sesh("customer_verify",array("pass"=>NULL,"fail"=>"reset"));
		$main->connect_db();
  ...
  <div class="login-box-body">
    <span class="block" id="notify"></span>
      <div class="form-group has-feedback">
       <?php $main->retrieve(['reset_question_customer',$_SESSION['customer_verify']['id']]);?>
      </div>
	  <div class="form-group has-feedback">
	   ...
	   <div class="block">
          <button class="btn btn-primary btn-block btn-flat" onclick=reset(["customer_question"])>Continue</button>
      </div>
  </div>
</div>
