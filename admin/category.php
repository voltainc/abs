...
<div class="wrapper">
  ...
  <?php echo $static->sidebar(['inner','admin','category','admin']);?>
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Category</h1>
    </section>
    <section class="content">
      <?php $main->retrieve(['category_list'])?>
    </section>
  </div>
			...
			<span id="notify"></span>
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" id="content" placeholder="Enter Category Name">
                </div>
              </div>
        </div>
      </div>
